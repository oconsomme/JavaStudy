public class ex01메서드기초 {
	...
	public static void main(String[] args) {
		...
		int a = 3;
		int b = 5;
		sum(a,b); // return result는 값만 보내주는 기능, 출력x
		System.out.println(sum(a,b)); // 값을 확인하고 싶으면 출력으로 감싸줘야한다
	...
	// 5) 매개변수 : 메서드 안에서 사요될 변수
	// 실행시킬때 보내주는 전달인자가 들어오는 곳 
	// + 매개변수는 반드시 선언만 되어있어야한다!
	// 선언 : int a;
	// 매개변수의 이름을 작성하는 것은 자율, 전달인자와 이름이 같지 않아도 됨
	// + 되도록이면 일치를 시켜주는 걸 권장
	//
	...
	public static int sum(int a, int b ) {
		...
		// : 리턴 타입 자리에 데이터 타입이 명시되어있으면 반드시 따라온다
		// + 리턴 타입 자리에 void가 있으면 작성x
	}
